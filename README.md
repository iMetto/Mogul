...
This fork (GitHub: ifBars/S1API) continues development with updates, fixes, and improvements while keeping the same spirit and goals.
...
Go check out the extremely helpful resources on our [GitHub](https://github.com/ifBars/S1API).
